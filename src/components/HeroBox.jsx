...
const HeroBox = () => {
  return (
    <div className="bento-item span-3 row-2 reveal" style={{ justifyContent: 'center' }}>
      ...
      <h1 style={{ fontSize: 'clamp(2.5rem, 6vw, 4.5rem)', lineHeight: '1.2', marginBottom: '1.5rem' }}>
        Preserving Value. <br />
        <span className="text-gradient">Safeguarding Assets.</span>
      </h1>
      <p style={{ color: 'var(--text-secondary)', fontSize: '1.2rem', maxWidth: '500px', marginBottom: '2rem' }}>
